...
const file_appointment_proto_rawDesc = "" +
	...
	"\aorderNo\x18\x03 \x01(\tR\aorderNo2i\n" +
	"\vAppointment\x12Z\n" +
	"\x11CreateAppointment\x12!.appointment.CreateAppointmentReq\x1a\".appointment.CreateAppointmentRespB\x06Z\x04./pbb\x06proto3"
...
var file_appointment_proto_depIdxs = []int32{
	...
	1, // 1: appointment.Appointment.CreateAppointment:output_type -> appointment.CreateAppointmentResp
