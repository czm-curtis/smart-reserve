...
const file_appointment_proto_rawDesc = "" +
	"\n" +
	"\x11appointment.proto\x12\x11appointmentclient\"N\n" +
	...
	"\aorderNo\x18\x03 \x01(\tR\aorderNo2u\n" +
	"\vAppointment\x12f\n" +
	"\x11CreateAppointment\x12'.appointmentclient.CreateAppointmentReq\x1a(.appointmentclient.CreateAppointmentRespB\x15Z\x13./appointmentclientb\x06proto3"
...
var file_appointment_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_appointment_proto_goTypes = []any{
	(*CreateAppointmentReq)(nil),  // 0: appointmentclient.CreateAppointmentReq
	(*CreateAppointmentResp)(nil), // 1: appointmentclient.CreateAppointmentResp
}
var file_appointment_proto_depIdxs = []int32{
	0, // 0: appointmentclient.Appointment.CreateAppointment:input_type -> appointmentclient.CreateAppointmentReq
	1, // 1: appointmentclient.Appointment.CreateAppointment:output_type -> appointmentclient.CreateAppointmentResp
